...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <fieldset id="nom_ville">
        ...
        <br/>
        <h3><xsl:value-of select="/siteData/currentConditions[1]/dateTime[2]/textSummary[1]"/></h3>
    ...
    <div id="currentcond">
        <div id="currentcond-left"><img id="currentimg" src="img/icones_png/{$icone}.png"  height="100" width="100" alt="{$condition}" title="{$condition}"></img>
